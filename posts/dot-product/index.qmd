...
I'll provide the best proof I have so far, though it might lack clear geometric intuition.
...
We already proved for $\alpha=0$, i.e, when $\textbf{b}=[1, 0]$. Now, we want to prove that $\alpha > 0$ does not change the algebraic dot product, i.e., that it is invariant under rotations. To do this, we derive an alternative formula for the dot product:
