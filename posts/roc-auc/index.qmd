...
```{ojs}
//| echo: false
viewof thresholdSlider2 = htl.html`<input type=range min=0 max=1.1 step=0.01 value=0.5 style="width:600px">`
``` 
...
The ROC AUC score represents the area of the light gray region in the above visualization. 

The ROC AUC score is 0.5 for a random classifier and closer to 1.0 for a perfect classifier. 
