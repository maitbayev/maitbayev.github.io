...
3. [wikipedia.org/wiki/Receiver_operating_characteristic](https://en.wikipedia.org/wiki/Receiver_operating_characteristic) - the Wikipedia entry
...
Luckily we have metrics that show the performance of a ML model at varying threshold values. 
...
**Tip**: Try the slider above and compare the matching green circle with the matching red circles.
