---
title: "Draft: Linear Equation Intuition"
...
# Draft: Linear Equation Intuition
...
Feel free to **play** (by moving) with the point $\textbf{n}$ and notice how the line equation is changing w.r.t to the normal vector.
...
function make_board(name, props) {
  ...
  const sliderAlpha = board.create("slider", [[-1, -3], [1, -3], [0, 45, 360]], {
    name: "alpha",
    snapWidth: 1
  });
